...
#define PORT_2_GLOBAL_SELECT   0x30    //Port 2 global select register (PRT2GS)
#define PORT_2_DRIVE_0         0x25    //Port 2 drive mode 0 register (PRT2DM0)
#define PORT_2_DRIVE_1         0xde    //Port 2 drive mode 1 register (PRT2DM1)
#define PORT_2_DRIVE_2         0xca    //Port 2 drive mode 2 register (PRT2DM2)
#define PORT_2_INTENABLE       0x4     //Port 2 interrupt enable register (PRT2IE)
#define PORT_2_INTCTRL_0       0x4     //Port 2 interrupt control 0 register (PRT2IC0)
#define PORT_2_INTCTRL_1       0x4     //Port 2 interrupt control 1 register (PRT2IC1)
