...
;       Instance name UART_1, Block Name RX(DCB03)
	...
	db		2dh, c1h		;UART_1_RX_INPUT_REG  (DCB03IN)
	db		2eh, 40h		;UART_1_RX_OUTPUT_REG (DCB03OU)
;       Instance name UART_1, Block Name TX(DCB02)
	db		28h, 1dh		;UART_1_TX_FUNC_REG   (DCB02FN)
	db		29h, 01h		;UART_1_TX_INPUT_REG  (DCB02IN)
...
;  Global Register values Bank 1
	...
	db		e1h, b0h		; OscillatorControl_1 register (OSC_CR1)
...
;  Ordered Global Register values
	...
	M8C_SetBank1
	mov	reg[08h], 25h		; Port_2_DriveMode_0 register (PRT2DM0)
	mov	reg[09h], deh		; Port_2_DriveMode_1 register (PRT2DM1)
	M8C_SetBank0
